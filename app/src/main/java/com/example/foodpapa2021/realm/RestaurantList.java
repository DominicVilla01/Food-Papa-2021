...
public class RestaurantList extends RealmObject {
    ...
    public String getRes_time_distance() {
        return res_time_distance;
    }

    public void setRes_time_distance(String res_time_distance) {
        this.res_time_distance = res_time_distance;
    }
